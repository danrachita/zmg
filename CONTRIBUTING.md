...
The Zmg project operates an open contributor model where anyone is
...
The following applies to code changes to the Zmg project, and is not to be
confused with overall ZMG Network Protocol consensus changes.

Whether a pull request is merged into Zmg rests with the project merge
...
Patches that change ZMG consensus rules are considerably more involved than
...
Where a patch set proposes to change the ZMG consensus, it must have been
...
The project leader is the release manager for each Zmg release.
