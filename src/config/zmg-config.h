/* src/config/zmg-config.h.  Generated from zmg-config.h.in by configure.  */
/* src/config/zmg-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "zmining.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Zmg Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Zmg Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "zmg"
