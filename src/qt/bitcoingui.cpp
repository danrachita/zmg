...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ZMG address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zmg: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Zmg"), this);
    aboutAction->setStatusTip(tr("Show information about Zmg"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ZMG"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ZMG addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ZMG addresses"));
    ...
    openAction->setStatusTip(tr("Open a ZMG: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Zmg help message to get a list with possible ZMG command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Zmg client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ZMG network", "", count));
}
...
{
    QString strTitle = tr("Zmg"); // default title
