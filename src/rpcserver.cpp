...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Zmg features */
        {"zmg", "masternode", &masternode, true, true, false},
        {"zmg", "listmasternodes", &listmasternodes, true, true, false},
        {"zmg", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zmg", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zmg", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zmg", "masternodedebug", &masternodedebug, true, true, false},
        {"zmg", "startmasternode", &startmasternode, true, true, false},
        {"zmg", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zmg", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zmg", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zmg", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zmg", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zmg", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zmg", "mnbudget", &mnbudget, true, true, false},
        {"zmg", "preparebudget", &preparebudget, true, true, false},
        {"zmg", "submitbudget", &submitbudget, true, true, false},
        {"zmg", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zmg", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zmg", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zmg", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zmg", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zmg", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zmg", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zmg", "checkbudgets", &checkbudgets, true, true, false},
        {"zmg", "mnsync", &mnsync, true, true, false},
        {"zmg", "spork", &spork, true, true, false},
        {"zmg", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"zmg", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use zmgd, or the -server option to zmg-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> zmg-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:30300/\n";
}
